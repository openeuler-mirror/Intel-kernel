...
static const __initconst struct x86_cpu_id cpu_vuln_whitelist[] = {
	...
	VULNWL_INTEL(INTEL_ATOM_SILVERMONT_MID2,	NO_L1TF | MSBDS_ONLY | NO_SWAPGS | NO_ITLB_MULTIHIT),
...
static const struct x86_cpu_id cpu_vuln_blacklist[] __initconst = {
	...
	VULNBL_INTEL_STEPS(INTEL_SKYLAKE_X,		      0x5,	VMSCAPE),
	VULNBL_INTEL_STEPS(INTEL_SKYLAKE_X,	     X86_STEP_MAX,	MMIO | RETBLEED | GDS | VMSCAPE),
	...
	VULNBL_INTEL_STEPS(INTEL_KABYLAKE_L,		      0xb,	VMSCAPE),
	VULNBL_INTEL_STEPS(INTEL_KABYLAKE_L,	     X86_STEP_MAX,	MMIO | RETBLEED | GDS | SRBDS | VMSCAPE),
	VULNBL_INTEL_STEPS(INTEL_KABYLAKE,		      0xc,	VMSCAPE),
	VULNBL_INTEL_STEPS(INTEL_KABYLAKE,	     X86_STEP_MAX,	MMIO | RETBLEED | GDS | SRBDS | VMSCAPE),
	...
	VULNBL_INTEL_STEPS(INTEL_COMETLAKE,	     X86_STEP_MAX,	MMIO | MMIO_SBDS | RETBLEED | GDS | VMSCAPE),
	VULNBL_INTEL_STEPS(INTEL_COMETLAKE_L,		      0x0,	MMIO | RETBLEED | VMSCAPE),
	VULNBL_INTEL_STEPS(INTEL_COMETLAKE_L,	     X86_STEP_MAX,	MMIO | MMIO_SBDS | RETBLEED | GDS | VMSCAPE),
